  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-0 sm:p-4 bg-black/80 backdrop-blur-md">
      <motion.div
        ...
        className="w-full max-w-4xl h-dvh sm:h-auto sm:max-h-[90vh] bg-zinc-950 border border-zinc-800 rounded-none sm:rounded-2xl shadow-2xl flex flex-col overflow-hidden text-white"
      >
        {/* Header */}
